...
//5,6. advanced - pagination
//5. pagination 함수: 한 페이지에 maximumList만큼 질문 목록을 렌더링 합니다.
const pagination=(maximumList)=>{//한 페이지 최대 갯수
  let allListsNum=agoraStatesDiscussions.length; //전체 리스트 길이
...
//초기화
//버튼 클릭 이벤트
const elpageBtn=document.querySelectorAll('.pagination > button'); //페이지네이션 버튼
